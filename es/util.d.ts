...
export declare function getImageSize(node: HTMLElement, options?: Options): {
    width: number;
    height: number;
};
...
export declare function imageToCanvas(node: HTMLElement, img: HTMLImageElement, options?: Options): HTMLCanvasElement;
