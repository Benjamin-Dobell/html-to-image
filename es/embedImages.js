    ...
    return __awaiter(this, void 0, void 0, function* () {
        yield Promise.all([
            new Promise((resolve, reject) => {
                var _a;
                const source = (_a = clonedNode.style) === null || _a === void 0 ? void 0 : _a.getPropertyValue('border-image-source');
                if (!source) {
                    resolve(clonedNode);
                    return;
                }
            ...
            new Promise((resolve, reject) => {
                var _a;
                const source = (_a = clonedNode.style) === null || _a === void 0 ? void 0 : _a.getPropertyValue('border-image');
                if (!source) {
                    resolve(clonedNode);
                    return;
                }
