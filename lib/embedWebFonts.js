...
function getCSSRules(styleSheets, options) {
    return __awaiter(this, void 0, void 0, function () {
        var ret, deferreds, inlineSheet, effectiveSheets;
        return __generator(this, function (_a) {
            ret = [];
            deferreds = [];
            inlineSheet = styleSheets.find(function (a) { return a.href == null; }) || document.styleSheets[0];
            effectiveSheets = [inlineSheet];
            ...
            return [2 /*return*/, Promise.all(deferreds).then(function () {
                    ...
                    effectiveSheets.forEach(function (sheet) {
                        if ('cssRules' in sheet) {
                            try {
