        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!options.clone) return [3 /*break*/, 2];
                    return [4 /*yield*/, options.clone(node)];
                case 1:
                    _a = _b.sent();
                    return [3 /*break*/, 3];
                case 2:
                ...
                case 3:
                    clonedNode = _a;
                    if (!!clonedNode) return [3 /*break*/, 5];
                    return [4 /*yield*/, cloneSingleNode(node, options)];
                case 4:
                    clonedNode = _b.sent();
                    _b.label = 5;
                case 5: return [2 /*return*/, Promise.resolve(clonedNode)
                        .then(function (targetNode) { return cloneChildren(node, targetNode, options); })
                        .then(function (targetNode) { return decorate(node, targetNode); })];
            }
        });
    });
}
