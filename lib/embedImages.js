...
function embedBorderImage(clonedNode, options) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.all([
                        new Promise(function (resolve, reject) {
                            var _a;
                            var source = (_a = clonedNode.style) === null || _a === void 0 ? void 0 : _a.getPropertyValue('border-image-source');
                            if (!source) {
                                resolve(clonedNode);
                                return;
                            }
                            Promise.resolve(source)
                                .then(function (cssString) { return (0, embedResources_1.embedResources)(cssString, null, options); })
                                .then(function (cssString) {
                                var priority = clonedNode.style.getPropertyPriority('border-image-source');
                        ...
                        new Promise(function (resolve, reject) {
                            var _a;
                            var source = (_a = clonedNode.style) === null || _a === void 0 ? void 0 : _a.getPropertyValue('border-image');
                            if (!source) {
                                resolve(clonedNode);
                                return;
                            }
                            Promise.resolve(source)
                                .then(function (cssString) { return (0, embedResources_1.embedResources)(cssString, null, options); })
                                .then(function (cssString) {
                                var priority = clonedNode.style.getPropertyPriority('border-image');
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, Promise.resolve(clonedNode)
                    ...
                    .then(function (node) { return embedBorderImage(node, options); })
